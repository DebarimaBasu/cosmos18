...
// //   const { user } = usePrivy();
// const { user } = useUser();
// const createdBy = user?.primaryEmailAddress?.emailAddress || user?.emailAddresses?.[0]?.emailAddress;
...
//       folder: [],
//       createdBy,
//       //createdBy: user?.primaryEmailAddress || user?.emailAddresses[0]?.emailAddress,
//     //   createdBy: user.email.address,
//     };
//     console.log("User before sending:", user);
//     console.log("CreatedBy before sending:", user?.primaryEmailAddress || user?.emailAddresses[0]?.emailAddress);
